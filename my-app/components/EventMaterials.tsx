...
type EventMaterialsProps = {
    eventId: number;
    isApproved: boolean; // only show if participant is approved
};
    ...
    return (
        <div className="flex items-start justify-between gap-4 rounded-xl border border-slate-800 bg-slate-950/40 p-4 transition hover:bg-slate-950/70">
            ...
            <button
                ...
                className="flex-shrink-0 rounded-lg bg-primary/10 p-2.5 text-primary transition hover:bg-primary/20"
